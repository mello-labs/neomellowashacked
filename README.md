...
com.github=NEO-PROTOCOL
com.twitter=SEUUSUARIO
com.linkedin=SEUUSUARIO
email=neo@neoprotocol.space
url=https://neoprotocol.space
description=Arquiteto de ecossistemas digitais. IA, automação, blockchain e sistemas de valor descentralizado.
notice=Identity anchored in ENS. Proof-first infrastructure.
org.telegram=SEUUSUARIO
network.base.address=0xSEU_ENDERECO_AQUI
app.farcaster=seuuser
app.lens=seuuser
